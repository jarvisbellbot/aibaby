...
const styles = StyleSheet.create({
  ...
  message: { fontSize: 20, fontWeight: '700', color: colors.text, textAlign: 'center', marginBottom: 8 },
  submessage: { fontSize: 14, color: colors.textSecondary, textAlign: 'center' },
});
